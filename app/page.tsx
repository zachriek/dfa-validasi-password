...
const generateElements = (validStates: string[]): ElementDefinition[] => {
	...
	const transitions: ElementDefinition[] = [
		...
		{ data: { source: 'q1', target: 'q1', label: '*', id: 'e1-1', type: 'invalid-state' } },
		...
		{ data: { source: 'q2', target: 'q2', label: '*', id: 'e2-2', type: 'invalid-state' } },
		...
		{ data: { source: 'q3', target: 'q3', label: '*', id: 'e3-3', type: 'invalid-state' } },
		...
		{ data: { source: 'q4', target: 'q4', label: '*', id: 'e4-4', type: 'invalid-state' } },
		{ data: { source: 'q5', target: 'q5', label: '*', id: 'e5-5', type: 'valid-state' } },
